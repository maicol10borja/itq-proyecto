...
public class InventarioController {
    ...
    private ResponseEntity<?> processTransaccion(Map<String,Object> body, String tipo) {
        try {
            ...
            var obra = obraRepo.findById(idObra).get();
            ...
            t.setTipo(tipo); t.setCantidad(cant); t.setPrecioUnitario(Double.parseDouble(body.get(tipo.equals("Compra")?"costo":"pvp").toString()));
